...
# + the resident firmware in ota_0. NVS region (0x9000) is never written —
# config/license data survive.
...
# it lacks the PSRAM/MSPI bootloader config the stock firmware needs and panics
# in early init (Load access fault after pmu_pvt). The stock dumped bootloader
# (IDF v5.5-dirty, Dec 2025) boots both the stock firmware (idf 5.4.3) and the
# launcher.
